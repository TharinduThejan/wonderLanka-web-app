...
const locationsData = [
  {
    ...
    rating: 4.8,
    img: '../../public/images/TempleofTheTooth/p1.jpg',
    ...
    gallery: [
      '../../public/images/TempleofTheTooth/p1.jpg',
      '../../public/images/TempleofTheTooth/p2.jpg',
      '../../public/images/TempleofTheTooth/p3.jpg',
      '../../public/images/TempleofTheTooth/p4.jpg',
      '../../public/images/TempleofTheTooth/p5.jpg'
  ...
  },
  {
    ...
    category: 'Culture',
    tags: 'Culture • Heritage',
    img: '../../public/images/Gallefort/p1.jpg',
    ...
    gallery: [
      '../../public/images/Gallefort/p1.jpg',
      '../../public/images/Gallefort/p2.jpg',
      '../../public/images/Gallefort/p3.jpg'
    ]
  },
  {
    ...
    category: 'Nature',
    tags: 'Nature • Gardens',
    img: '../../public/images/peradeniyaGarden/p1.jpg',
    ...
    gallery: [
      '../../public/images/peradeniyaGarden/p1.jpg',
      '../../public/images/peradeniyaGarden/p2.jpg',
      '../../public/images/peradeniyaGarden/p3.jpg'
    ]
  },
  {
    ...
    img: '../../public/images/Sinharaja/p3.jpg',
    ...
    gallery: [
      '../../public/images/Sinharaja/p1.jpg',
      '../../public/images/Sinharaja/p2.jpg',
    ]
  },
  {
    ...
    gallery: [
      '../../public/images/yala/p2.jpg',
      '../../public/images/yala/p3.jpg'
    ]
  },
  {
    id: 'adams-peak',
    ...
    img: '../../public/images/Sripada/p1.jpg',
    ...
    gallery: [
      '../../public/images/Sripada/p1.jpg',
      '../../public/images/Sripada/p2.jpg',
      '../../public/images/Sripada/p3.jpg'
    ]
  },

  {
    ...
    gallery: [
      '../../public/images/SriMahaBodhi/srimahabodhi1.jpg',
      '../../public/images/SriMahaBodhi/srimahabodhi2.jpeg',
  ...
  },
  {
    ...
    category: 'Culture',
    tags: 'Culture • Heritage',
    img: '../../public/images/Sigiriya/p2.jpg',
   ...
   gallery: [
      '../../public/images/Sigiriya/p1.jpg',
      '../../public/images/Sigiriya/p3.jpg'
    ]
  },
 {
    ...
    img: '../../public/images/Heritance Kandalama/p2.jpg',
    ...
    description: 'Designed by the legendary Sri Lankan architect Geoffrey Bawa, Heritance Kandalama is a pioneering example of tropical modernist architecture. The hotel is built seamlessly into a rock face and is entirely engulfed by the surrounding jungle, stretching nearly a kilometer long. It overlooks the serene Kandalama Lake and offers distant views of the Sigiriya Rock Fortress. Nature reclaims the structure with lush vegetation cascading from the terraces, creating an eco-friendly sanctuary that merges perfectly with the wilderness.',
     gallery: [
      '../../public/images/Heritance Kandalama/p1.jpg',
      '../../public/images/Heritance Kandalama/p3.jpg'
    ]
  ...
  },
  {
    ...
    img: '../../public/images/Galle Face Hotel/p1.jpg',
   ...
   gallery: [
      '../../public/images/Galle Face Hotel/p2.jpg',
      '../../public/images/Galle Face Hotel/p3.jpg'
    ]
  },
  {
    id: '98-acres-resort',
    ...
    img: '../../public/images/98 Acres Resort/p1.jpg',
    ...
    description: 'Perched on a scenic 98-acre tea estate in Ella, this luxurious eco-resort offers some of the most breathtaking panoramic views in Sri Lanka\'s central highlands. The individual chalets are uniquely designed, built using recycled materials like discarded railway sleepers and thatched with \'Illuk\' straw to blend harmoniously with the environment. Overlooking the majestic Ella Gap and Little Adam\'s Peak, the resort provides a tranquil haven for relaxation, complete with a world-class spa and easy access to Ella\'s famous nature trails.',
     gallery: [
      '../../public/images/98 Acres Resort/p3.jpg',
      '../../public/images/98 Acres Resort/p2.jpg'
    ]
  }
];
